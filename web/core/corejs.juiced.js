 ...
 * 
 * Juicer build (manual):
 *  php lib/juicer/JuicerCLI.php -v --webroot web --config apps/core/config/juicer.config.php --infile web/js/core/corejs.juicy.js
 *   
 */
...
(function() {
  ...
  if (typeof(window.console) !== "undefined" /*&& typeof(window.loadFirebugConsole) !== "undefined"*/)
  {
    Core.log = function() {
 ...
 *   toggle()                    Toggle display of element
 * 
 *  
 * @author Fabrice Denis
 */
...
(function(){
  ...
  Core.Ui =
  {
    ...
    /**
     * Sets or toggle display of element.
     * 
     * Uses empty string instead of "block" to reset display value in case
     * it was not "block".
     * 
     * Usage:
     *   // set display
     ...
     * @param {Bool} display     Boolean (optional)
     */
...
/*jslint forin: true */
/*global window, Core, App, RegExp, alert, console, document */
/**
 * EventDelegator
 * 
 ...
 *                                   the root element. Use e.target (yui3) in this handler to get the
 ...
 *     the event chain use e.target (yui3).
 *     
...
(function(){
   ...
   */
  Core.Ui.EventDelegator = Core.createClass();
  ...
  EventDelegator.prototype =
  {
    ...
    _handler: function(e)
    {
      ...
      //App.log("EventDelegator(%o, %o)", e, elTarget);
      ...
      while (elTarget && elTarget !== this.elRoot)
      {
        ...
        if (elTarget.id && elTarget.id.length)
        {
          ...
          if (this.listeners[idEvent] && this._fire(idEvent, e, elTarget) === false)
          {
            Event.stopEvent(e);
            return false;
          }
        ...
        classes = elTarget.className.split(/\s+/);
        ...
        if (this.listeners[tagEvent] && this._fire(tagEvent, e, elTarget) === false)
        {
          Event.stopEvent(e);
          return false;
        }
    ...
    _fire: function(name, e, matchedEl)
    {
      ...
      var context = Y.lang.isUndefined(oListener.context) ? window : oListener.context;
...
/*! Javascript Framework by Fabrice Denis - http://kanji.koohii.com */
/**
 * Core.Widgets
 * 
 * @author    Fabrice Denis
