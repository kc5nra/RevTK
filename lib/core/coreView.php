...
class coreView
{
  ...
  protected function configure($moduleName, $actionName, $viewName)
  {
    ...
    {
      $this->directory = coreConfig::get('app_template_dir');
      $this->template = $actionName.'View'.$this->getExtension();
    }
    else
    {
      $this->directory = coreConfig::get('app_module_dir').'/'.$moduleName.'/templates';
  ...
  {
    if (coreToolkit::isPathAbsolute($template))
    {
    ...
    {
      $this->directory = coreConfig::get('app_module_dir').'/'.$this->context->getModuleName().'/templates';
  ...
  public function setDecoratorTemplate($templateName)
  {
    ...
    $this->decoratorFile = coreConfig::get('app_template_dir').'/'.$templateName.'View'.$this->getExtension();
  }
