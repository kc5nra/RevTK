...
<div style="padding:3px 5px;background:#ffa020;font:12px Georgia;color:#4b2b00;">
  Assertion failed in file <b>{$file}</b> at line <b>{$line}</b> with code :
  <div style="background:#ffd9a6;padding:2px 5px;color:#000;margin:4px 0 0;">
    <code>{$code}</code>
  </div>
</div>
EOD;
...
EOD;
    ...
    throw new coreException('Error: '.$errstr);
