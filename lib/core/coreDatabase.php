 ...
 *
 * @todo       Add debugging support, eg. store all queries to know how many queries run
 *             probably best as a separate coreDatabaseProfile class.
 *
...
abstract class coreDatabase
{
  ...
  /**
   * Returns the SQL query log, as an array of strings. 
   *
   * @return  array 
   */
