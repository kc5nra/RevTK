    ...
    init: function(url, options)
    {
      ...
      if (options.form) {
        ...
        if (!formObject.nodeName || formObject.nodeName.toLowerCase()!=='form') {
          Core.halt("AjaxRequest() 'form' is not a FORM element");
        }
      ...
      if (params)
      {
        ...
        else if (Y.lang.isObject(params))
        {
          ...
          Core.halt("AjaxRequest() invalid typeof options.parameters");
        }
        ...
        if (options.method === 'GET')
        {
          ...
          if (requestUri.indexOf("?") >= 0) {
            Core.halt("AjaxRequest() Request url already contains parameters");
          }
        ...
        else if (options.method === 'POST')
        {
          ...
          if (requestUri.indexOf("?") >= 0) {
            Core.halt("AjaxRequest() POST request url contains query string (unsupported)");
          }
